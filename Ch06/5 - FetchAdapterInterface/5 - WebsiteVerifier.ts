import { INetworkAdapter, NetworkAdapterFetchResults } from "./5 - INetworkAdapter";
...
export const isWebsiteAlive = async (network: INetworkAdapter): Promise<WebsiteAliveResult> =>
{
